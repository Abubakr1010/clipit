...
urlpatterns = [
    ...
    path('all_videos/<int:pk>', views.VideoViewSet.as_view({'get':'all_videos'}), name='all_videos'),
    path('recent_video/<int:pk>/', views.FiltersViewSet.as_view({'get':'recent_videos'}), name='recent_video'),
    path('oldest_video/<int:pk>/', views.FiltersViewSet.as_view({'get':'oldest_video'}), name='oldest_video'),
